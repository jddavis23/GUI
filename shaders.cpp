...
int main()
{
	...
	//a buffer is created and then binded as a specific type and then
	//the coordinates are stored within
		// unsigned int VBO;
		// glGenBuffers(1, &VBO);
	...
	glfwSetFramebufferSizeCallback(window, framebuffer_size_callback);
				...
				/*CREATING A VERTEX*/
	//source code is stored in a string to allow compilation at runtime
